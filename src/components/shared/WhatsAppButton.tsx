...
export default function WhatsAppButton() {
  ...
  // The button should appear after scrolling past the hero section (approx 600-800px)
  const opacity = useTransform(scrollY, [600, 800], [0, 1]);
  const scale = useTransform(scrollY, [600, 800], [0.5, 1]);
  ...
  return (
    <motion.a
      ...
      style={{ opacity, scale }}
      className="fixed bottom-8 right-8 z-50 w-16 h-16 bg-[#25D366] rounded-full flex items-center justify-center shadow-2xl hover:scale-110 transition-transform duration-300"
    >
      <svg
        viewBox="0 0 24 24"
